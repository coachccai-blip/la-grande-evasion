...
window.HINT_I18N = {
  ...
  map: {
    ...
    "Accorde le participe (voix passive)":             {en:"Make the participle agree (passive voice)",  zh:"使过去分词配合（被动语态）"},
    "Accorde le participe passé (auxiliaire avoir)":   {en:"Make the past participle agree (with « avoir »)", zh:"配合过去分词（助动词 avoir）"},
    "Accorde le participe passé (auxiliaire être)":    {en:"Make the past participle agree (with « être »)",  zh:"配合过去分词（助动词 être）"},
    ...
    "Forme l'adverbe en -ment":                        {en:"Form the « -ment » adverb", zh:"构成以 -ment 结尾的副词"},
    ...
    "Paronymes (mots proches à ne pas confondre)":     {en:"Paronyms (easily confused words)", zh:"近形词（易混淆的词）"},
    "Quel type de phrase ?":                           {en:"What type of sentence?", zh:"这是哪种类型的句子？"},
